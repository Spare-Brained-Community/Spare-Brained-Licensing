...
{
    DefaultImplementation = "SPBLIC ILicenseCommunicator" = "SPBLIC Gumroad Communicator", "SPBLIC ILicenseCommunicator2" = "SPBLIC Gumroad Communicator", "SPBLIC IUsageIntegration" = "SPBLIC Gumroad Communicator";
    Extensible = true;
